...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/APSiren/APSiren.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FLAnimatedImage_Applicaster/FLAnimatedImage_Applicaster.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MPNotificationView_Applicaster/MPNotificationView_Applicaster.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Mixpanel/Mixpanel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NKJWT/NKJWT.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SHMKit/SHMKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/e-planning/e_planning.framework"
fi
