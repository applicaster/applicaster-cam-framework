...
#import "APASIHTTPRequest.h"

@interface APASIDownloadCache : NSObject <APASICacheDelegate> {
...
+ (BOOL)serverAllowsResponseCachingForRequest:(APASIHTTPRequest *)request;
...
@property (assign, nonatomic) APASICachePolicy defaultCachePolicy;
