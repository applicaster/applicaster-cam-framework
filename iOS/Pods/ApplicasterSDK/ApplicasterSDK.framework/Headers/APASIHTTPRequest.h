...
#import <stdio.h>
#import "APASIHTTPRequestConfig.h"
#import "APASIHTTPRequestDelegate.h"
#import "APASIProgressDelegate.h"
#import "APASICacheDelegate.h"

@class APASIDataDecompressor;

extern NSString *APASIHTTPRequestVersion;
...
// The error domain that all errors generated by APASIHTTPRequest use
extern NSString* const APNetworkRequestErrorDomain;
...
extern unsigned long const APASIWWANBandwidthThrottleAmount;
...
@interface APASIHTTPRequest : NSOperation <NSCopying> {
	...
	id <APASIHTTPRequestDelegate> delegate;
	...
	id <APASIHTTPRequestDelegate, APASIProgressDelegate> queue;
	...
	id <APASIProgressDelegate> uploadProgressDelegate;
	...
	id <APASIProgressDelegate> downloadProgressDelegate;
	...
	APASIDataDecompressor *dataDecompressor;
...
+ (id)requestWithURL:(NSURL *)newURL usingCache:(id <APASICacheDelegate>)cache;
+ (id)requestWithURL:(NSURL *)newURL usingCache:(id <APASICacheDelegate>)cache andCachePolicy:(APASICachePolicy)policy;
...
+ (void)setDefaultCache:(id <APASICacheDelegate>)cache;
+ (id <APASICacheDelegate>)defaultCache;
...
+ (NSThread *)threadForRequest:(APASIHTTPRequest *)request;
...
@property (copy) NSString *proxyDomain;

@property (copy) NSString *proxyHost;
@property (assign) int proxyPort;
@property (copy) NSString *proxyType;
...
@property (copy) NSString *downloadDestinationPath;
@property (copy) NSString *temporaryFileDownloadPath;
@property (copy) NSString *temporaryUncompressedDataDownloadPath;
...
@property (copy,readonly) NSString *authenticationRealm;
@property (copy,readonly) NSString *proxyAuthenticationRealm;
...
@property (copy,readonly) NSString *responseStatusMessage;
...
@property (assign) APASIHTTPRequest *mainRequest;
...
@property (copy) NSString *postBodyFilePath;
...
@property (copy) NSString *proxyAuthenticationScheme;
...
@property (assign) id <APASICacheDelegate> downloadCache;
@property (assign) APASICachePolicy cachePolicy;
@property (assign) APASICacheStoragePolicy cacheStoragePolicy;
...
#endif
@property (retain) APASIDataDecompressor *dataDecompressor;
