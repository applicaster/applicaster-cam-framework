...
//This method is called in order to register for push messages
...
//This Method is called when Push Notification was pressed by the user, using Appoxee pre-defined actions,
//actions inheriting from Appoxee's pre-defined actions or full custom
-(void)appoxeeInteractivePushNotificationPressedWithCategory:(NSString*)category andPayload:(NSDictionary*)pushPayload;

//This Method is called when button1 was pressed by the user within the push notification, using Appoxee pre-defined actions,
//actions inheriting from Appoxee's pre-defined actions or full custom
-(void)appoxeeInteractivePushButton1PressedWithCategory:(NSString*)category andPayload:(NSDictionary*)pushPayload;

//This Method is called when button2 was pressed by the user within the push notification, using Appoxee pre-defined actions,
//actions inheriting from Appoxee's pre-defined actions or full custom
-(void)appoxeeInteractivePushButton2PressedWithCategory:(NSString*)category andPayload:(NSDictionary*)pushPayload;
